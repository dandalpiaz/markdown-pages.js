...
<figure class="figure-right" style="width: 500px;">
    <a href="./assets/example.jpg" target="_blank">
        <img src="./assets/example.jpg" alt="an example image with caption" />
    </a>
...
<img src="./assets/example.jpg" style="width: 100%;" alt="an example image" />

### Heading Level 3

<img class="img-left" src="./assets/example.jpg" style="max-width: 500px;" alt="an example image" />
