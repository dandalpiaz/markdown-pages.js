...
_`Last Updated: 12/1/2025`_ [`edit`](https://github.com/dandalpiaz/markdown-pages/edit/main/README.md) <button id="light-toggle" onclick="toggleLight()" aria-label="switch to light mode" aria-pressed="false">🌗</button>
